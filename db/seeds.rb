first_user = User.create(name: 'Tom', photo: 'https://picsum.photos/id/1/200/300', bio: 'Teacher from Mexico.', email: 'a@gmail.com', password: '111111', password_confirmation: '111111', confirmed_at: DateTime.now)
